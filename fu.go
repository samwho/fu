...
func Int32s(in []int32) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
...
func Int64s(in []int64) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
...
func Uint32s(in []uint32) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
...
func Uint64s(in []uint64) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
...
func Float32s(in []float32) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
...
func Float64s(in []float64) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
...
func Strings(in []string) []interface{} {
	is := make([]interface{}, 0, len(in))
	for _, i := range in {
		is = append(is, i)
	}
